...
import CfConnect4SocialMediaAccounts4Controller, {
  Props,
  configJSON,
} from "./CfConnect4SocialMediaAccounts4Controller";

export default class CfConnect4SocialMediaAccounts4 extends CfConnect4SocialMediaAccounts4Controller {
