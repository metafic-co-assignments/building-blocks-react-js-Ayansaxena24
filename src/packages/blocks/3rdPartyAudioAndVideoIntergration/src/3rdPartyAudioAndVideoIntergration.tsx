...
import 3rdPartyAudioAndVideoIntergrationController, {
  Props,
  configJSON,
} from "./3rdPartyAudioAndVideoIntergrationController";

export default class 3rdPartyAudioAndVideoIntergration extends 3rdPartyAudioAndVideoIntergrationController {
