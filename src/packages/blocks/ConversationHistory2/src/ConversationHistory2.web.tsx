...
import ConversationHistory2Controller, {
  Props,
  configJSON,
} from "./ConversationHistory2Controller";

export default class ConversationHistory2 extends ConversationHistory2Controller {
